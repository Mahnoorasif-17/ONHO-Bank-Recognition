...
# =========================
# Load files
# (edit these paths only if needed)
# =========================
batch_df = pd.read_excel(r"C:\Users\ADMIN\Documents\ONHO\Batch Aug.xlsx")
rta_df   = pd.read_excel(r"C:\Users\ADMIN\Documents\ONHO\RTA.xlsx")
...
output_file = f"(1)LastDiscoverDateRange_Recon_Combined_{target_date}.xlsx"
wb.save(output_file)
